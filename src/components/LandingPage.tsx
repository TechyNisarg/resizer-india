      ...
      <div style={{ textAlign: 'center', marginBottom: '0', padding: '2rem 1rem 1rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1.5rem', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '2rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-primary)', fontSize: '0.95rem', fontWeight: 500 }}>
             <ShieldCheck size={18} style={{ color: 'var(--success)', position: 'relative', top: '1px' }} /> <span>No Server Uploads</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-primary)', fontSize: '0.95rem', fontWeight: 500 }}>
             <FileText size={18} style={{ color: 'var(--primary)', position: 'relative', top: '1px' }} /> <span>Accurate File Sizes</span>
          </div>
        </div>
      </div>
      ...
      <div style={{ marginBottom: '4rem', padding: '0 1rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '1.5rem' }}>
          ...
          <div 
            ...
            title="Open Tools Sidebar (Alt+M / Option+M)"
          >
