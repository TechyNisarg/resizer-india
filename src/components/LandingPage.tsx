...
const CATEGORIES = [
  ...
  { id: 'passport', label: 'Passport Size', icon: Plane, desc: 'Standard Indian Passport/Visa sizes (2x2 inch or 51x51mm). Perfect for online OCI or Passport Seva applications.', path: '/passport-photo-resizer' },
